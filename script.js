        ...
        function updateJobTable() {
            ...
            jobs.forEach((job, index) => {
                ...
                row.innerHTML = 
                    `<td>J${job.id}</td>
                    <td><input type="number" value="${job.arrivalTime}" min="0" onchange="updateJobProperty(${index}, 'arrivalTime', this.value)"></td>
                    <td><input type="number" value="${job.burstTime}" min="1" onchange="updateJobProperty(${index}, 'burstTime', this.value)"></td>
